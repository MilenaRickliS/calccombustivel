...
child: Form(
  ...
  child: Column(
    ...
    children: <Widget>[
      Icon(Icons.car_crash_outlined , size: 120.0, color: const Color.fromARGB(255, 114, 23, 23)), // Ícone decorativo
      TextFormField(

        keyboardType: TextInputType.number, // Define o teclado numérico
        decoration: InputDecoration(
        labelText: " valor do preço do álcool ", // Texto do rótulo
...
TextFormField(
  ...
  decoration: InputDecoration(
  labelText: " valor do preço da gasolina ",
